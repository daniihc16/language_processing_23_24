...
------------------------------------------------------
function func_con_params(bool_param: boolean, integer_param: integer, char_param: char, array_param: array(1..5) of integer,
                        ref_bool_param: ref  boolean, ref_integer_param: ref integer, ref_char_param: ref char, 
...
------------------------------------------------------
procedure proc_con_params(bool_param: boolean, integer_param: integer, char_param: char, array_param: array(1..5) of integer,
                        ref_bool_param: ref boolean, ref_integer_param: ref integer, ref_char_param: ref char, 
                        ref_array_param: ref array(1..5) of integer,) 
is
begin
...
------------------------------------------------------
function fun_sin_params return integer is
begin
	return 1;
end;
------------------------------------------------------

procedure a is
	var_a, var_b: integer;
	enb: integer;
    v_array: array(-1..3) of integer;
    
procedure proc_con_v(v: array(-1..3) of integer) is
begin 
    null;
end;
procedure proc_con_v_ref(v_por_ref: ref array(-1..3) of integer) is
begin
